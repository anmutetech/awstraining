...
This project deploys to the `migration-eks-cluster` provisioned by the `cloud-migration-infra` setup. Complete the [Cloud Migration Infrastructure README](../cloud-migration-infra/README.md) before proceeding.
...
cd awstraining/legacy-app-modrnization
```
...
From the `legacy-app-modrnization` directory:
...
> **Note:** This only removes the application. To destroy the underlying EKS cluster, follow the cleanup steps in the [Cloud Migration Infrastructure README](../cloud-migration-infra/README.md).

## Project Structure

```
legacy-app-modrnization/
├── .github/workflows/
